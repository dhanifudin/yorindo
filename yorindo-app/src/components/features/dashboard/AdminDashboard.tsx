...
export function AdminDashboard() {
  ...
  const pendingRegistrations = 42 // Phase 2 will wire real data
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-3">
          <Button asChild>
            <Link href="/app/events">Buat Event</Link>
          </Button>
          <Button asChild variant="outline">
            <Link href="/app/contacts/upload">Upload Kontak</Link>
          </Button>
          <Button asChild variant="outline">
            <Link href="/app/events">Lihat Laporan</Link>
          </Button>
        </div>
      </div>
    </div>
