...
This document provides the complete epic and story breakdown for Yorindo, decomposing requirements from the PRD and Architecture into implementable stories. **Priority directive:** FE Foundation + OpenAPI/MSW mocking first.
