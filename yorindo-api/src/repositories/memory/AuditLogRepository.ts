...
const SEED_ENTRIES: Array<Omit<AuditLog, 'id' | 'createdAt'> & { daysAgo: number }> = [
  ...
  { action: 'contact.flag', actorId: SEED_USER_IDS.admin, actorRole: 'admin', eventId: null, targetId: SEED_CONTACT_IDS[44]!, targetType: 'contact', metadata: { category: 'spam' }, daysAgo: 2 },
